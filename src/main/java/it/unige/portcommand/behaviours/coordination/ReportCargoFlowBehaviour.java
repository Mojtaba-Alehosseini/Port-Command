 ...
 */
public final class ReportCargoFlowBehaviour extends TickerBehaviour {

    private static final Logger log = LoggerFactory.getLogger(ReportCargoFlowBehaviour.class);

    public ReportCargoFlowBehaviour(Agent agent) {
        super(agent, 1000L);
    }
