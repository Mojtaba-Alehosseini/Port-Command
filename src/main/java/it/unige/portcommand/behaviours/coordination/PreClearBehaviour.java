 ...
 */
public final class PreClearBehaviour extends OneShotBehaviour {

    private static final Logger log = LoggerFactory.getLogger(PreClearBehaviour.class);

    public PreClearBehaviour(Agent agent) {
        super(agent);
    }
