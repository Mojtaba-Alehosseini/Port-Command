 ...
 */
public final class ConfirmBerthReadinessBehaviour extends OneShotBehaviour {

    private static final Logger log = LoggerFactory.getLogger(ConfirmBerthReadinessBehaviour.class);

    public ConfirmBerthReadinessBehaviour(Agent agent) {
        super(agent);
    }
