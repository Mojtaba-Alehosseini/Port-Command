 ...
 */
public final class WeatherThresholdAlertBehaviour extends CyclicBehaviour {

    private static final Logger log = LoggerFactory.getLogger(WeatherThresholdAlertBehaviour.class);

    public WeatherThresholdAlertBehaviour(Agent agent) {
        super(agent);
    }
