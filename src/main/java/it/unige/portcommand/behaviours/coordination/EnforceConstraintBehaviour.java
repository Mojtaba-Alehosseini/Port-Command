 ...
 */
public final class EnforceConstraintBehaviour extends CyclicBehaviour {

    private static final Logger log = LoggerFactory.getLogger(EnforceConstraintBehaviour.class);

    public EnforceConstraintBehaviour(Agent agent) {
        super(agent);
    }
