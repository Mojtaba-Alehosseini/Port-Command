 ...
 */
public final class RefuseBerthBehaviour extends OneShotBehaviour {

    private static final Logger log = LoggerFactory.getLogger(RefuseBerthBehaviour.class);

    public RefuseBerthBehaviour(Agent agent) {
        super(agent);
    }
