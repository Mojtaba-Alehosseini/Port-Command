 ...
 */
public final class ListenForRequestsBehaviour extends CyclicBehaviour {

    private static final Logger log = LoggerFactory.getLogger(ListenForRequestsBehaviour.class);

    public ListenForRequestsBehaviour(Agent agent) {
        super(agent);
    }
